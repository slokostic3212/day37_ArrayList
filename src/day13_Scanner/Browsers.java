...
public class Browsers {
    public static void main(String[] args) {
        String browserName = "safari"; // no long boolean long float dbl
        ...
        switch (browserName){
            case "chrome":
                ...
                break;
            case "firefox":
                System.out.println("Opening Firefox Browsder");
                break;
            case "opera":
            ...
            case "edge":
                ...
                break;
            default:
                System.out.println("Invalid Browser Name");// if no break = no compile error but logical error
