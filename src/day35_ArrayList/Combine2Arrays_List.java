...
public class Combine2Arrays_List {
    public static void main(String[] args) {
        ...
        ArrayList<String> studentList = new ArrayList<>();// arrayslist is a class and called automatically
        ...
        System.out.println(studentList);//[Aalia, Mohammed, Aslan, Ernis, Zarina, Mee, Irina, Virginia, Ali, Dawud]
    }
}
